    ...
    <div class="row">
        <div class="col-md-8">
            <div class="well well-sm">
                <form class="public-form" action="{{ route('public.postContact') }}" method="POST">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="name">
                                Message</label>
                            <textarea name="contact_sms" id="message" class="form-control" rows="9" cols="25" required="required"
